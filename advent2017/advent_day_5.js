...
function day5a(offsets){
  ...
  while( i < offsets.length){
    ...
    var temp = i;       //console.log("i: "+i); console.log("value: "+ offsets[i]);
    i += offsets[i];    //console.log("new i: "+i);
    offsets[temp]++;  //console.log("new value: "+offsets[temp]);
    sum++;              //console.log('-----------------');
    
    //console.log(temp+', '+offsets[i]+', '+i);
    if(sum == 1000000){
      console.log("i: "+i+" value: "+offsets[i]);
      return sum;
    }
  }
