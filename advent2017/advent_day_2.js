...
$('#day2a-ans').html( day2a( $('#day2-input').html() ) );
...
$('#day2b-ans').html( day2b( day2Input ) );

function day2a( input ){
  return "42299 (I just used a spreadsheet to do this one)";
}
      ...
      for(var k=0; k<input[i].length; k++){
        ...
        if(input[i][j] % input[i][k] == 0){
          if(input[i][j] != input[i][k]){
            ...
            //console.log(input[i][j]+"/"+input[i][k]+"="+(input[i][j] / input[i][k]));
          }
        }
      }
